...
class Object2DSplitter {
 ...
 public:
	...
	void split(OdimH5v20::OdimObject* obj) {
		const std::string& objtype = obj->getObject();
		assert( objtype != OdimH5v20::OBJECT_IMAGE || objtype != OdimH5v20::OBJECT_COMP );

		OdimH5v20::HorizontalObject_2D& o = dynamic_cast<OdimH5v20::HorizontalObject_2D&>(*obj);
		assert(o.getProductCount() == 2) ;

		for (int nprod = 0; nprod < o.getProductCount(); nprod++) {
			OdimH5v20::Product_2D* prod = o.getProduct(nprod);
...
int main()
{
	...
	OdimH5v20::OdimFactory factory;
  	OdimH5v20::OdimObject* object = factory.open(TESTFILE);
	try {
