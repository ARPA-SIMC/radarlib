...
#ifndef __RADAR_ODIMH5V21_CONST_HPP__
#define __RADAR_ODIMH5V21_CONST_HPP__
...
namespace OdimH5v21 
{
	...
	extern RADAR_API const char* CONVENTIONS_ODIM_H5_V2_1;
...
/*===========================================================================*/
	...
	extern RADAR_API const char* ATTRIBUTE_HOW_RXBANDWIDTH;
	extern RADAR_API const char* ATTRIBUTE_HOW_LOWPRF; 
	extern RADAR_API const char* ATTRIBUTE_HOW_HIGHPRF;
	extern RADAR_API const char* ATTRIBUTE_HOW_TXLOSS;
	extern RADAR_API const char* ATTRIBUTE_HOW_RXLOSS;
	extern RADAR_API const char* ATTRIBUTE_HOW_ANTGAIN;
	extern RADAR_API const char* ATTRIBUTE_HOW_BEAMWH;
	extern RADAR_API const char* ATTRIBUTE_HOW_BEAMWV;
	extern RADAR_API const char* ATTRIBUTE_HOW_RADOMELOSS;
	extern RADAR_API const char* ATTRIBUTE_HOW_GASATTN;
	extern RADAR_API const char* ATTRIBUTE_HOW_RADCONSTH;
	extern RADAR_API const char* ATTRIBUTE_HOW_RADCONSTV;
	extern RADAR_API const char* ATTRIBUTE_HOW_NOMTXPOWER;
	extern RADAR_API const char* ATTRIBUTE_HOW_TXPOWER;
	extern RADAR_API const char* ATTRIBUTE_HOW_NI;
	extern RADAR_API const char* ATTRIBUTE_HOW_VSAMPLES;

	extern RADAR_API const char* ATTRIBUTE_HOW_AZMETHOD;
	extern RADAR_API const char* ATTRIBUTE_HOW_BINMETHOD;
//	extern RADAR_API const char* ATTRIBUTE_HOW_AZANGLES;       removed in ODIMh5 v2.1
	extern RADAR_API const char* ATTRIBUTE_HOW_ELANGLES;
	extern RADAR_API const char* ATTRIBUTE_HOW_STARTAZA;
	extern RADAR_API const char* ATTRIBUTE_HOW_STOPAZA;
	extern RADAR_API const char* ATTRIBUTE_HOW_STARTAZT;
	extern RADAR_API const char* ATTRIBUTE_HOW_STOPAZT;
...
//	extern RADAR_API const char* ATTRIBUTE_HOW_AZTIMES;       removed in ODIMh5 v2.1
...
//	extern RADAR_API const char* ATTRIBUTE_HOW_NI;       removed in ODIMh5 v2.1
	...
	extern RADAR_API const char* ATTRIBUTE_HOW_NEZ;
//	extern RADAR_API const char* ATTRIBUTE_HOW_MDS;       removed in ODIMh5 v2.1
