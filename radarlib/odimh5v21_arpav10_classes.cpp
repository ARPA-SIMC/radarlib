...
#include <radarlib/odimh5v21_arpav10_classes.hpp>
...
const char* CONVENTIONS_ODIM_H5_V2_1_ARPA_V0_1          = "ODIM_H5/V2_1 ARPA/V0_1";
const char* CONVENTIONS_ODIM_H5_V2_1_ARPA_V1_0          = "ODIM_H5/V2_1 ARPA/V1_0";
...
{
	return ::OdimH5v21::Specification::isMethod(value);
}

bool Specification::isPolarization(const std::string& value)
{
	return ::OdimH5v21::Specification::isPolarization(value);
}
